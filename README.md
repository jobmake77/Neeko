...
- 🤖 **多模型支持** — Claude、OpenAI、Kimi（月之暗面）、Gemini 可自由切换
...
- 至少一个 LLM API Key（Claude / OpenAI / Kimi / Gemini，在 Web UI 设置页配置）
...
| **LLM** | Anthropic Claude / OpenAI / Kimi（月之暗面）/ Gemini（Google） |
