...
| 路径 | 命令 | 场景 |
|------|------|------|
| **A：单人蒸馏** | `node dist/index.js create @elonmusk` | 有明确标杆人物，数据量充足 |
| **B：能力融合** | `node dist/index.js create --skill "全栈工程师"` | 无明确标杆，组合多位专家 |
...
# 如模型偶发格式错误，可增加自动重试次数
node dist/index.js train elonmusk --mode quick --retries 3
