...
const ZH: Record<string, string> = {
  ...
  thinking: '思考中…',
  replyModeClarify: '补充一下',
  replyModeProtected: '无法展示内部信息',
  replyModeDirect: '直接回答',
  replyHintClarify: '需要一点额外上下文后再继续',
  replyHintProtected: '已自动拦截内部实现相关请求',
  replyHintDirect: '按当前上下文直接回复',
  ...
  attachmentTypeAudio: '音频',
  attachmentTypeText: '文本',
  attachmentTypeFile: '文件',
  attachmentPrepared: '已附加',
  attachmentWaiting: '等待发送后处理',
  attachmentSource: '处理方式',
  attachmentUnavailable: '当前服务暂不可用',
  attachmentSummaryReady: '内容已提取，可参与本轮对话',
  attachmentSummaryPending: '发送后系统会自动处理',
  attachmentSummaryUnsupported: '当前模型暂不支持这类附件处理',
  attachmentSummaryError: '处理未完成，可稍后重试',
  copyMessage: '复制',
  deleteThread: '删除对话',
  renameThread: '重命名',
  newThread: '新建对话',
  ...
  modelSelect: '选择模型',
  chatModel: '聊天模型',
  noChatModel: '请先在设置中配置可用模型',
  modelForThisChat: '本轮对话使用',
  showKey: '显示',
  hideKey: '隐藏',
  capabilityStatus: '当前能力',
  capabilityImage: '图片理解',
  capabilityAudio: '音频转写',
  capabilityVideo: '视频转写',
  capabilityReady: '可用',
  capabilityNeedsKey: '缺少配置',
  capabilityPartial: '部分可用',
  capabilityPlanned: '待接入',
  capabilityImageReadyDesc: '可处理图片并提取本轮对话所需信息',
  capabilityImageMissingDesc: '需要配置支持图片理解的服务后才能处理图片',
  capabilityImageKimiCodeDesc: '当前 Kimi Code key 不能直接用于图片理解',
...
const EN: Record<string, string> = {
  ...
  thinking: 'Thinking…',
  replyModeClarify: 'Need context',
  replyModeProtected: 'Internal details blocked',
  replyModeDirect: 'Direct reply',
  replyHintClarify: 'A bit more context is needed before continuing',
  replyHintProtected: 'Internal implementation details were blocked automatically',
  replyHintDirect: 'Answered directly from the current context',
  ...
  attachmentPrepared: 'Attached',
  attachmentWaiting: 'Will process after sending',
  attachmentSource: 'Processor',
  attachmentUnavailable: 'Unavailable',
  attachmentSummaryReady: 'Content extracted and ready for this turn',
  attachmentSummaryPending: 'The system will process it after sending',
  attachmentSummaryUnsupported: 'Current model does not support this attachment type yet',
  attachmentSummaryError: 'Processing did not finish. Try again later',
  copyMessage: 'Copy',
  deleteThread: 'Delete',
  renameThread: 'Rename',
  ...
  cultivationCenter: 'Background Updates',
  ...
  noChatModel: 'Configure an available model in Settings first',
  modelForThisChat: 'Use for this chat',
  showKey: 'Show',
  hideKey: 'Hide',
  capabilityStatus: 'Capabilities',
  capabilityImage: 'Image Understanding',
  capabilityAudio: 'Audio Transcription',
  capabilityVideo: 'Video Transcription',
  capabilityReady: 'Ready',
  capabilityNeedsKey: 'Needs Config',
  capabilityPartial: 'Partial',
  capabilityPlanned: 'Planned',
  capabilityImageReadyDesc: 'Can analyze images for the current turn',
  capabilityImageMissingDesc: 'Configure an image-capable backend to process images',
  capabilityImageKimiCodeDesc: 'Current Kimi Code key cannot be used for image understanding',
  ...
  evidenceImports: 'Material Imports',
  trainingPreps: 'Update Prep',
  trainingPrep: 'Prep',
  fromHandoff: 'from curated result',
